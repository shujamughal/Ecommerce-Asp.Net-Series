...
using Project_Based_Learning.Hubs;
...
namespace Project_Based_Learning.Controllers
{
    public class ProductController : Controller
    {
        ...
        private readonly IHubContext<ProductHub> _prodHub;
        ...
        public ProductController(
            ...
            IHubContext<ProductHub> prodHub,
            ...
            try
            {
                ...
                return Json(new
                {
                    ...
                    product = new
                    {
                        ...
                        price = product.Price,
                        imageUrl = Url.Content("~/" + product.ImageUrl),
        ...
        public async Task<IActionResult> Create(Product product)
        {
            try
            {
                if (!ModelState.IsValid)
                {
                    ...
                    await _prodHub.Clients.All.SendAsync("ReceiveNotification", $"Product {product.Name} created successfully");
        ...
        public async Task<IActionResult> Edit(Product product)
        {
            try
            {
                if (!ModelState.IsValid)
                {
                    ...
                    await _prodHub.Clients.All.SendAsync("ReceiveProductUpdate", product.Id, product.Name, $"Product {product.Name} updated successfully");
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                _logger.LogInformation("Product {Name} deleted successfully", product.Name);
